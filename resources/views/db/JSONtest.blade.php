...
{!! Form::label('blperk', 'Shield Wall Perk Level (0-5):') !!}
  ...
  $(document).ready()
{
  ...
  $("#submitbtn").click(function(e)
  {
      ...
      $.ajax(
      {
         ...
         data:{name:name, smithlvl:smlvl, smithperk:smp, lalvl:la, laperk:lp, halvl:ha, haperk:hp, ohlvl:ol, ohperk:op, thlvl:tl, thperk:tp, arlvl:al, arperk:ap, bllvl:bl, blperk:bp},
